...
import TransformPipelineDiagram from "../assets/transform_pipeline.svg?react";
...
<TransformPipelineDiagram className="ld-docs-diagram mx-auto my-6 h-auto w-full max-w-xl rounded-lg" role="img" aria-label="Proxy transform pipeline" />
