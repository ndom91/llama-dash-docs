...
llama-dash does **not** run inference itself — that is the selected backend's job (currently [llama-swap](https://github.com/mostlygeek/llama-swap) over llama.cpp). It is a single-team, single-box tool, not a multi-tenant SaaS.
